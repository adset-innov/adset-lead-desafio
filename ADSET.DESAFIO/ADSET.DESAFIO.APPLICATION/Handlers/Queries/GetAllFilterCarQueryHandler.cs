...
{
    public class GetAllFilterCarQueryHandler : IRequestHandler<GetAllFilterCarQuery, PaginatedList<Car>>
    {
        private readonly ICarRepository _carRepository;

        public GetAllFilterCarQueryHandler(ICarRepository carRepository)
        {
            _carRepository = carRepository;
        }

        public async Task<PaginatedList<Car>> Handle(GetAllFilterCarQuery request, CancellationToken cancellationToken)
        {
